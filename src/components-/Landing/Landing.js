    ...
    <div id='landing' className="page">
      ...
      <div className="about-container">
        ...
        <div className="land-intro" >
          ...
          <div className="landing-blurb">
            Always glad to {connectLink} with folks and discuss opportunities, code, science, or the human condition.
          </div>
        </div>
      </div>
      </div>
